    ...
    return (
        ...
        <SafeAreaView style={styles.SafeAreaView2}>
          ...
          <View style={styles.outerWrapper}>
            ...
            <View>
              <Text  style={{ fontSize: 30, textAlign: "center", fontWeight: "bold", color: redColor }}  >Number of Led Tv At you Place</Text>
            </View>

            <View>
              <Image style={{ width: 250, height: 210 }} resizeMode="contain" source={TvPic}></Image>
            </View>

            
        <View style={{ margin: 10, width: '90%', borderWidth: 1, borderRadius: 10, borderColor: redColor}} >
    <TextInput
        placeholder="   Number of Tv at your place"
        onChangeText={setTv}
        value={Tv}
