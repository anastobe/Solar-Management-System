...
//pic
import MicroWavePic from "../assets/images/MicroWave.jpg"
...
const MicroWave = ({navigation, ...props}) => {
    ...
    return (
        ...
        <SafeAreaView style={styles.SafeAreaView2}>
          ...
          <View style={styles.outerWrapper}>
            ...
            <View>
              <Text  style={{ fontSize: 30, textAlign: "center", fontWeight: "bold", color: redColor }}  >Number of MicroWave</Text>
            </View>

            <View>
              <Image style={{ width: 250, height: 220 }} resizeMode="contain" source={MicroWavePic}></Image>
            </View>

            
        <View style={{ margin: 10, width: '90%', borderWidth: 1, borderRadius: 10, borderColor: redColor}} >
    <TextInput
        placeholder="   Number of MicroWave at your place"
        onChangeText={setMicroWave}
        value={MicroWave}
...
export default connect(mapStateToProps, mapDispatchToProps)(MicroWave) 
