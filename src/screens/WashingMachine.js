...
//pic
import WashingMachinePic from "../assets/images/WashingMachine.jpg"
...
const WashingMachine = ({navigation, ...props}) => {
    
    const [WashingMachine, setWashingMachine] = useState("")

    const saveData = () =>{
      props.setValue( 
        "WashingMachineValue", WashingMachine,
        )
      navigation.navigate("Iron")
    }
    ...
    return (
        ...
        <SafeAreaView style={styles.SafeAreaView2}>
          ...
          <View style={styles.outerWrapper}>
            ...
            <View>
              <Text  style={{ fontSize: 30, textAlign: "center", fontWeight: "bold", color: redColor }}  >Number of WashingMachine</Text>
            </View>

            <View>
              <Image style={{ width: 250, height: 220 }} resizeMode="contain" source={WashingMachinePic}></Image>
            </View>
    ...
    <TextInput
        ...
        onChangeText={setWashingMachine}
